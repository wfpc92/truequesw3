...
--
-- Servidor: localhost
-- Tiempo de generación: 05-06-2013 a las 11:27:25
...
(25, 'PC de Escritorio HP Pavilion w5030la', 'Hardware: Pentium4 515 (P) 2.93 GHz: bus frontal a 533 MHz, Zócalo LGA775, Juego de chips: Intel 915GV, Placa base: Fabricante: Asus, Nombre de la placa base: PTGD-LA, Nombre de la placa base de HP: Goldfish2-GL8E ,Unidad de disco duro: 120 GB SATA, 7200 rpm, Monitor con LCD plano de 15" con altavoces integrados, Monitor con LCD plano de 17" con altavoces integrados, Unidad 16x DVD(+/-)R/RW DL (debe utilizar discos de medios de doble capa a fin de aprovechar la tecnología DL)', 6, 'http://localhost/trueque_10//images/copmpu.jpg', '2013-04-21', 14),
(26, 'Balon de futbol americano', 'Esta autografiada por uno de los más grandes jugadores de la liga inglesa. La pelota reglamentaria de fútbol americano es de goma inflada y está recubierta de cuero o goma. Tiene la forma de un esferoide alargado, con una circunferencia de 72,4 cm alrededor del eje largo y 54 cm alrededor del eje corto; tiene entre 397 y 425 g de peso', 7, 'http://localhost/trueque_10//images/balonAmericano.jpg', '2013-04-17', 14),
(27, 'Equipo de sonido Sony Genezi', 'Características: Puerto USB capaz de reproducir y grabar en MP3, Reproducción de: discos CD-R/CD-RW y MP3, Potencia máxima: 4400W (PMPO), Potencia real: 400W (RMS), CD, Radio, Casete, Audio y USB (Entrada Portátil), Control remoto', 8, 'http://localhost/trueque_10//images/equipo.jpg', '2013-02-27', 14),
(28, 'Carro juguete', 'Hermoso regalo para tu hijo     tiene sonidos reales    volante direccional y   pito. Reconocida marca  -se entrega en su respectiva caja .Regalo ideal para su hijo', 10, 'http://localhost/trueque_10//images/cajaconCarros.jpg', '2013-05-22', 14),
(29, 'Accesorios para mujer', 'Cadena de plata con dijes en forma de estrella y luna. Esta acompañada por una pulsera y un anillo. Acero quirúrgico, cadena plata italiana.', 9, 'http://localhost/trueque_10//images/acces.jpg', '2013-06-02', 14),
...
(49, 'Cadena Corazon', 'Realizada en oro blanco, pavé de brillantes de calidad river por pétalos y un diamante  amarillo para aportar una nota de color. Femenina, elegante y sofisticada, una pieza exclusiva', 9, 'http://localhost/trueque_10//images/cadena4.jpg', '2013-06-04', 15),
(50, 'Controles XBox 360', 'Tecnología inalámbrica a 2,4 GHz con cobertura de 9 metros\r\nUsa hasta cuatro controles de manera simultanea con una consola\r\nPuerto de audífono integrado para jugar y comunicarte en Xbox LIVE\r\nVibración ajustable para alargar la duración de las baterías\r\nUsa el botón Guía Xbox 360 para mantenerte en contacto con tus amigos, acceder a tus juegos o para encender y apagar tu Xbox 360. Están como nuevos. Colores: Plateado y Rojo', 15, 'http://localhost/trueque_10//images/controles.jpg', '2013-06-04', 15),
(51, 'Lavadora Appiani 530 Lb', 'Lavado a vapor, esteriliza las prendas.\r\n11,4 kg de carga. Sistema de secado Direct Condensing Dry. Panel inclinado ergonómico. Tecnología antibacterial Nano silver. Bloqueo para niños. Limpieza de tambor. Bajo consumo energético.', 8, 'http://localhost/trueque_10//images/lavadora.jpg', '2013-06-04', 15),
(52, 'Antiguo Candelabro de Bronce', 'Antiguo candelabro de bronce y cristal cortado; 90 cms. de alto X 70 cms. de ancho, electrificado para 12 luces. En muy buen estado de conservación.', 1, 'http://localhost/trueque_10//images/candelabroPared.jpg', '2013-06-04', 16),
...
(55, 'Celular Nokia 301', 'El nokia 301 es un teléfono celular series 40 con una pantalla de 2.4 pulgadas, cámara de 3.2 megapixels, aplicaciones facebook, twitter, whatsapp, variedad de colores y cuenta también con una versión sim dual.', 4, 'http://localhost/trueque_10//images/nokia-301-feature.jpg', '2013-06-04', 16),
(57, 'Pelicula Blu Ray+DVD  El Turista', 'Película de 2010, remake de Anthony Zimmer (2005), dirigida por Florian Henckel von Donnersmarck y protagonizada por Johnny Depp y Angelina Jolie.', 5, 'http://localhost/trueque_10//images/foto_12027.jpg', '2013-06-04', 16),
(58, 'Dell Optiplex 755', 'Computadora de escritorio marca DELL Modelo Optiplex 755, de torre, con HDD de 160GB SATA, Memoria de 2GB DDR2, CD/DVD Lector SATA, 8 puertos USB, Microprocesador CORE 2 VPro de Doble Nucleo a 2.33GHz con bus de 1,333MHz y Cache de L2 de 4MB, con Monitor de LCD de 15", con teclado, Mouse y bocinas. le he instalado W7 Ultimate y trabaja perfectamente', 6, 'http://localhost/trueque_10//images/delloptiplex.jpg', '2013-03-05', 16),
(59, 'Bate de Beisbol Compuesto', 'Material: Fibra de carbono y aluminio, con  recubrimiento de pintura azul y agarre de goma. Cuenta con un año de uso.', 7, 'http://localhost/trueque_10//images/bates.jpg', '2013-06-02', 16),
(60, 'Licuadora Avance Collection HR1869/60', 'La licuadora Avance Collection HR1869/60 de Philips te permitirá disfrutar de excelentes zumos gracias a su potente motor de 2 velocidades de 700 W.\r\nSu tubo de alimentación XXL acepta frutas y verduras enteras. ¡No hay necesidad de cortar los ingredientes! Además, te permite hacer hasta 2,5 litros de zumo y servirlo fácilmente. \r\nEquipada con elementos lavables en el lavavajillas, la licuadora de Philips Avance Collection HR1869/60 también recupera toda la pulpa en el mismo lugar para un vaciado fácil.', 8, 'http://localhost/trueque_10//images/licuadora.jpg', '2013-06-04', 16),
(61, 'Anillo de Con Imitación de Diamante Dorado', 'Anillo de moda para mujer de color oro. Los materiales son cristal y aleación. Dimensiones: 13x8x5', 9, 'http://localhost/trueque_10//images/anilloGrande.jpg', '2013-04-25', 16),
(62, 'Carro de Control Remoto', 'Carro de Control Remoto Land-Rover RRS Autorizado RC, Fuente de poder: Brush Electric, Tipo de Auto: On-Road, Color: Negro/Blanco, Distancia Control Remoto: 20m, Batería para el transmisor: 9V.', 10, 'http://localhost/trueque_10//images/carrito.jpg', '2013-04-17', 16),
...
(77, 'PROFICOOK AE1002. Licuadora + Batidora de Vaso', '- Licuadora profesional construida en acero inoxidable de alta calidad\r\n- Potencia 1200 W\r\n- Jarra de zumo de 1000 ml aprox\r\n- 9 niveles de velocidad\r\n- Contenedor de pulpa de 2 l aprox.\r\n- Boca de llenado extra grande\r\n- Extrae un 30% más de zumo\r\n \r\nBatidora:\r\n- Recipiente de 1,8 l\r\n- Apto para lavavajillas\r\n- Circuito de seguridad', 8, 'http://localhost/trueque_10//images/licuadroraymas.jpg', '2013-06-04', 17),
(78, 'Juego de Anillos para dama', 'Juego de tres anillos para dama. Contiene un anillo con un hermoso diamante, con aplicaciones de oro. Otro anillo con diamantes originales y finalmente una imitacion de esmeraldas.', 9, 'http://localhost/trueque_10//images/anillos.jpg', '2013-06-04', 17),
...
(81, 'Guitarra Fender CD 60 KB', '-Número de cuerdas: 6 cuerdas\r\n-Forma del cuerpo: Dreadnought\r\n-Cutaway: No\r\n-Construcción: Laminada\r\n-Color: Negro\r\n-Acabado: Brillante\r\n-Tapa armónica: Abeto rojo europeo\r\n-Fondo/Aros: Caoba\r\n-Mástil: Nato\r\n-Diapasón: Palisandro\r\n-Inlays en el diapasón: Dots\r\n-Anchura de la cejilla: 43 mm', 13, 'http://localhost/trueque_10//images/descarga.jpg', '2013-06-04', 17),
(82, 'Carro clasico volkswagen', 'Con motor 1600, documentos al dia,con sonido entrada usb, cauchos nuevos, tapiceria buen diseño,pintura cromo', 14, 'http://localhost/trueque_10//images/carroAntiguo.jpg', '2013-06-04', 17),
...
(84, 'Coche antiguo', 'Se vende carrito de bebes antiguo en muy buen estado ideal para decoracion por solo 250e es probable que tenga unos 50 o 60 años esta muy poco visto.', 1, 'http://localhost/trueque_10//images/coche.jpg', '2013-06-04', 18),
...
(94, 'Apartamento Barrio San José Medellin', 'Posee 3 cuartos. Apartamento ubicado en un primer piso en un Multifamiliar, en el barrio San José, el apartamento tiene 3 alcobas, 2 baños, sala, comedor, cocina, patio y garaje, está enrejado', 3, 'http://localhost/trueque_10//images/departamentoEnCurauma.jpg', '2013-06-04', 23),
...
(98, 'Samsung Rex 80', 'El samsung rex 80 es un teléfono celular gsm con una pantalla tft qvga de 3 pulgadas, cámara de 3.2 megapixels, wi-fi b/g/n, bluetooth 3.0, sim dual opcional, integración con redes sociales y ranura microsd', 4, 'http://localhost/trueque_10//images/343997.jpg', '2013-06-04', 24),
...
(102, 'Camara Canon Retina Plegable', 'Esta retina plegable incorpora una estructura metálica exterior alrededor del fuelle protegiéndolo y dándole quizás una mayor protección contra la luz y una mayor durabilidad.', 2, 'http://localhost/trueque_10//images/cam10.jpg', '2013-06-04', 25),
...
(19, 'Karen', 'Bolaños', 'karen@gmail.com', 'eee82986f34d650e5554e2850f7408368587b0fb', 1, 0, 'http://localhost/trueque_10/images/avatar.jpg'),
